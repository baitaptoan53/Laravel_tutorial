        ...
        <li class="dropdown notification-list topbar-dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-right dropdown-menu-animated topbar-dropdown-menu">
                ...
                <a href="javascript:void(0);" class="dropdown-item notify-item">
                    <img src={{ asset('images/flags/germany.jpg') }} alt="user-image" class="mr-1" height="12">
                ...
                <!-- item-->
                <a href="javascript:void(0);" class="dropdown-item notify-item">
                    <img src={{ asset('/images/flags/spain.jpg') }} alt="user-image" class="mr-1" height="12">
                    <span class="align-middle">Spanish</span>
                </a>

                <!-- item-->
                <a href="javascript:void(0);" class="dropdown-item notify-item">
                    <img src={{ asset('/images/flags/russia.jpg') }} alt="user-image" class="mr-1" height="12">
